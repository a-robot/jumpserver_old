...
from jperm.views import perm_rule_list, perm_rule_add, perm_rule_detail, perm_rule_edit, \
        perm_rule_delete, perm_role_list, perm_role_add, perm_role_delete, perm_role_detail, \
        perm_role_edit, perm_role_push, perm_role_recycle, perm_role_get, perm_sudo_list, \
        perm_sudo_add, perm_sudo_delete, perm_sudo_edit
